...
Description: Covid data from 01.01.2020 - 31.03.2023
*/
...
-- Showing breakdown of total death count per population by continent
...
-- Showing global numbers of total death count per population 
...
SELECT dea.continent, dea.location, dea.date, dea.population, ac.new_vaccinations, SUM(CONVERT(bigint,vac.new_vaccinations)) OVER (PARTITION BY dea.Location ORDER BY dea.location, dea.Date) AS RollingPeopleVaccinated, (RollingPeopleVaccinated/population)*100
